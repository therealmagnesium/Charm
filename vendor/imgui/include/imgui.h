...
namespace ImGui
{
    ...
    IMGUI_API bool ButtonFramed(const char* label, const ImVec2& size = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
    ...
    IMGUI_API bool ImageButtonEmpty(const char* str_id, const ImVec2& image_size, float thickness, ImGuiButtonFlags flags = 0);
